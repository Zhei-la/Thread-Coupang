...
이래서 사람들이 찾는 건가 싶더라`,
    ...
    '쿠팡': `쿠팡 구매 클릭 유도 SNS 글. 1~3줄. 읽는 순간 클릭하고 싶게 만들어야 함.
...
- 첫 줄에 바로 클릭 욕구를 자극하는 어그로성 표현
- 경험담처럼 자연스럽게 (광고티 절대 금지)
- 부정적인 표현, 불만, 단점 절대 금지 (예: 별로, 실망, 안좋음, 후회 등 금지)
- 뻔한 말 금지: 가성비, 추천, 좋은제품, 강추
- 이모지 금지, 반말
- 예시 복붙 금지, 주제에 맞게 새로 창작
- 제품명/브랜드명 절대 언급 금지 → "이거", "이것", "요거"로 둘러 말할 것
- 제품명 대신 반응, 상황, 감정으로만 표현
- 읽는 사람이 궁금해서 클릭하지 않고는 못 배기게 만들 것`
  };
...
[절대 규칙]
- 반드시 한국어로만 작성. 단, 주제 자체가 영어 단어인 경우(예: AI, SNS, IT 등)는 그대로 써도 됨. 그 외 영어단어, 한자, 일본어, 중국어, 기타 외국어 단 한 글자도 절대 사용 금지. 위반 시 재생성
- 이모지 절대 사용 금지
